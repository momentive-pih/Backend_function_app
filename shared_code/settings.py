...
sfdc_column_str="MATCHEDPRODUCTVALUE,MATCHEDPRODUCTCATEGORY,CASENUMBER,SOP_TIER_2_OWNER_EMAIL_FORMULA__C,REASON,MANUFACTURINGPLANT,BU,ACCOUNTNAME"
sfdc_column=["MATCHEDPRODUCTVALUE","MATCHEDPRODUCTCATEGORY","EMAILSUBJECT","CASENUMBER","SOP_TIER_2_OWNER_EMAIL_FORMULA__C","EMAILATTACHMENT","EMAILBODY","CONTACTEMAIL","REASON","MANUFACTURINGPLANT","BU","ACCOUNTNAME"]
sfdc_case_call=["MATCHEDPRODUCTVALUE","MATCHEDPRODUCTCATEGORY","CASENUMBER","REASON","SOP_TIER_2_OWNER_EMAIL_FORMULA__C","ACCOUNTNAME","BU","MANUFACTURINGPLANT"]
...
# get_ontology_id_query="select coalesce(max(id),0)+1 as id from momentive.[ontology]"
get_ontology_id_query="select id,ontology_value from momentive.[ontology]"